...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		try {
		//	URL url=new URL("http://10.0.2.2/myadroidweb/login.php?username="+username+"&password="+password);
			URL url=new URL("http://10.0.2.2/android/login.php?username="+username+"&password="+password);
		//	http://localhost/myadroidweb/login.php?username=admin&password=ccs
